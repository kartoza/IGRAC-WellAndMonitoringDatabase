...
from gwml2.forms.well.yield_measurement import WellYieldMeasurementForm
from gwml2.forms.well.level_measurement import WellGroundwaterLevelMeasurementForm
from gwml2.forms.well.quality_measurement import WellQualityMeasurementForm
