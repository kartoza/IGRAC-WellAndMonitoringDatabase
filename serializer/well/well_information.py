...
class WellLikeFormSerializer(WellSerializer, serializers.ModelSerializer):
    ...
    def get_level_measurement(self, obj):
        ...
        :type obj: Well
        """
        return WellLevelMeasurementSerializer(obj.welllevelmeasurement_set.all(), many=True).data
    ...
    def get_quality_measurement(self, obj):
        ...
        :type obj: Well
        """
        return WellQualityMeasurementSerializer(obj.wellqualitymeasurement_set.all(), many=True).data
    ...
    def get_yield_measurement(self, obj):
        ...
        :type obj: Well
        """
        return WellYieldMeasurementSerializer(obj.wellyieldmeasurement_set.all(), many=True).data
