# Generated by Django 2.2.12 on 2020-10-19 05:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hydrogeology_parameter', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.HydrogeologyParameter')),
                ('management', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.Management')),
                ('purpose', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.TermWellPurpose')),
                ('status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.TermWellStatus')),
                ('top_borehole_elevation', models.OneToOneField(blank=True, help_text='Elevation of Top of Borehole Above Sea Level.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='top_borehole_elevation', to='gwml2.Quantity')),
            ],
            options={
                'db_table': 'well',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=512, unique=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('parameters', models.ManyToManyField(blank=True, null=True, to='gwml2.TermMeasurementParameter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_elevation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.TermReferenceElevationType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.CharField(blank=True, max_length=512, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('bottom_depth', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='structure_bottom_depth', to='gwml2.Quantity')),
                ('construction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.Construction')),
                ('diameter', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='structure_diameter', to='gwml2.Quantity')),
                ('reference_elevation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.TermReferenceElevationType')),
                ('top_depth', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='structure_top_depth', to='gwml2.Quantity')),
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.TermConstructionStructureType')),
            ],
            options={
