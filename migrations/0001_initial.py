# Generated by Django 2.2.12 on 2020-08-21 04:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('failed_explanation', models.TextField(blank=True, null=True)),
            ],
            options={
                'db_table': 'drilling',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('manager', models.CharField(blank=True, max_length=512, null=True, verbose_name='Manager / owner')),
                ('description', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.OneToOneField(blank=True, help_text='value of elevation with unit', null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.Quantity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('elevation', models.OneToOneField(blank=True, help_text='Elevation of the feature.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.Quantity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quality', models.OneToOneField(blank=True, help_text='The quality of the result', null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.Quantity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(blank=True, null=True)),
                ('depth', models.OneToOneField(blank=True, help_text='Top depth of feature', null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.Quantity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stratigraphic_unit', models.CharField(blank=True, help_text='Stratigraphic unit of the log.', max_length=256, null=True)),
                ('bottom_depth', models.OneToOneField(blank=True, help_text='Bottom depth of the log', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stratigraphic_log_bottom_depth', to='gwml2.Quantity')),
                ('drilling', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gwml2.Drilling')),
                ('top_depth', models.OneToOneField(blank=True, help_text='Top depth of the log', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stratigraphic_log_top_depth', to='gwml2.Quantity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('bottom_depth', models.OneToOneField(blank=True, help_text='Bottom depth of the feature', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='screening_bottom_depth', to='gwml2.Quantity')),
                ('construction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.Construction')),
                ('diameter', models.OneToOneField(blank=True, help_text='Diameter of the feature', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='screening_diameter', to='gwml2.Quantity')),
                ('top_depth', models.OneToOneField(blank=True, help_text='Top depth of the feature', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='screening_top_depth', to='gwml2.Quantity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specific_capacity', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pumping_test_specific_capacity', to='gwml2.Quantity')),
                ...
                ('transmissivity', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pumping_test_transmissivity', to='gwml2.Quantity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.CharField(blank=True, help_text='material of the feature.', max_length=512, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('bottom_depth', models.OneToOneField(blank=True, help_text='Bottom depth of the feature', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='casing_bottom_depth', to='gwml2.Quantity')),
                ('construction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gwml2.Construction')),
                ('diameter', models.OneToOneField(blank=True, help_text='Diameter of the feature', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='casing_diameter', to='gwml2.Quantity')),
                ('top_depth', models.OneToOneField(blank=True, help_text='Top depth of the feature', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='casing_top_depth', to='gwml2.Quantity')),
            ],
            options={
