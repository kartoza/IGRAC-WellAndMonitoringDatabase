...
class Migration(migrations.Migration):
    dependencies = [
        ('gwml2', '0058_downloadrequest_organisationtype'),
    ]
    ...
    sql = """
            ...
            CREATE MATERIALIZED VIEW mv_well_ggmn AS select DISTINCT ON (id) id, organisation || '-' || original_id AS ggis_uid, original_id, name, feature_type,purpose, status,organisation, country, year_of_drilling, aquifer_name, aquifer_type,manager, detail, location, created_at, created_by, last_edited_at, last_edited_by from vw_well where number_of_measurements > 0;
