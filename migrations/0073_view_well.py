...
class Migration(migrations.Migration):
    ...
    views = """
            ...
            select DISTINCT ON (id) id, organisation || '-' || original_id AS ggis_uid, 
                   original_id, 
                   name,
                   description,
                   feature_type,
            ...
            from vw_well where number_of_measurements > 0 and organisation is not null;
    ...
    operations = [
        ...
        migrations.RunSQL(functions, default),
    ]
